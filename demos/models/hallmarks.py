"""The hallmarks of aging as perturbation handles on the demo models.

Every mapping here names a process of the demo composites (`multi_hallmark`,
`eriq`, `stem_cell_niche`), which is why the registry lives with them and
not in the library: :mod:`hallsim.handles` is the machinery, this is one
registry built with it.
...
:class:`hallsim.handles.Handle` entry.
"""
