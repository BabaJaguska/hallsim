...
| MODEL1904150001 | Scheidel2016 Salmonella xenophagy | autophagy | wrong-formalism | Petri net: 69 reactions and 0 kinetic laws and 0 parameters; a knockout map of bacterial xenophagy, not an integrable model | scratch/2026-09-07-sweep/A.md |
| MODEL2402030002 | Riya2024 NSCLC immune-inflammasome-autophagy | autophagy | cell-type-mismatch | NSCLC tumour plus macrophage, DC, NK, Th and M2 compartments, no fibroblast; also carries its own JNK, Akt and mTOR so it duplicates DP14; as deposited it does not import because sbmltoodejax treats one libsbml annotation warning as fatal, though a copy with annotations stripped imports and solves | scratch/2026-09-07-sweep/A.md |
| MODEL1608180000 | MartinJimenez2017 astrocyte genome-scale metabolism | autophagy | wrong-formalism | genome-scale constraint-based reconstruction with 9448 species and 5659 reactions; its only pattern hit is lactosylceramide (lc3Cer), not LC3; import fails with a libsbml read error | scratch/2026-09-07-sweep/A.md |
| BIOMD0000000192 | Görlich2003 RanGTP gradient | nuclear-lamina | not-identifiable | closed Ran cycle with conserved total; emits protein-pool redistributions only and the benchmark transcriptome has no observable for them (RAN, RANBP1, RANGAP1, NUTF2 all within 0.22 log2); also drives a state negative and declares no time unit | scratch/2026-09-07-sweep/D.md |
| BIOMD0000000164 | SmithAE2002 Ran transport | nuclear-lamina | not-identifiable | same closed Ran cycle; 11 of 26 states are microinjected fluorescent tracer copies and one is the pipette; no transcript readout exists for any emitted species | scratch/2026-09-07-sweep/D.md |
| BIOMD0000000434 | McAuley2012 whole-body cholesterol | lipid-damage | cell-type-mismatch | organism-level hepatic/intestinal/peripheral compartments with LDL/HDL/VLDL plasma pools; the only deposit any repository returned for lipofuscin, AGEs or lipid aging, and it has no cellular state to couple a fibroblast to | scratch/2026-09-07-sweep/D.md |
